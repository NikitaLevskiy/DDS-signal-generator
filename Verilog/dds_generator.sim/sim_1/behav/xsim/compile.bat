...
REM
REM Generated by Vivado on Fri Oct 03 11:32:16 +0200 2025
...
echo "xvlog --incr --relax -prj dds_generator_tb_vlog.prj"
call xvlog  --incr --relax -prj dds_generator_tb_vlog.prj -log xvlog.log
